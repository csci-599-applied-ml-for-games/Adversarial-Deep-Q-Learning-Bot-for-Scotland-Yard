...
class BaseAIProtocol(basic.LineOnlyReceiver):
   ...
   # def getEnivronment(self):
   #    log.msg("ENIVIROMENT CALLED!!")
   #    # output_file = "/Users/shreyasi/Desktop/LondonLaw/eniviroment.txt"
   #    # dets      = ['Red', 'Yellow', 'Green', 'Blue', 'Black']
   #    # detLocs   = [self._pawns[d].getLocation() for d in dets]
   #    # # f = open(output_file, "w")
   #    # self.f.write("DETECTIVE LOCATIONS: "+ str(detLocs)+"\n")
   #    # tickets = [self._pawns[d]._tickets for d in dets]
   #    # # log.msg("DETETIVE tickets: "+ str(tickets))
   #    # self.f.write("DETECTIVE TICKETS: "+ str(tickets)+"\n")
   #    # mrX_loc = self._pawns['X'].getLocation()
   #    # self.f.write("Mr. X Location: "+ str(mrX_loc)+"\n")
   #    # mrX_tickets = self._pawns['X']._tickets
   #    # self.f.write("Mr. X Tickets: "+ str(mrX_tickets)+"\n")
   #    log.msg(str(self._pawns["X"]._loc)+" "+str(self._pawns["X"].getPlayer())+"\n\n\n")
      
   # def mrXEnvs(self, mrX_loc, mrX_tickets):
   #    log.msg("Mr X ENIVIROMENT CALLED!!")
   #    self.f.write("Mr. X's turn .. \n")
   #    self.f.write("Mr. X Location: "+ str(mrX_loc)+"\n")
   #    self.f.write("Mr. X Tickets: "+ str(mrX_tickets)+"\n")
   #    dets      = ['Red', 'Yellow', 'Green', 'Blue', 'Black']
   #    detLocs   = [self._pawns[d].getLocation() for d in dets]
